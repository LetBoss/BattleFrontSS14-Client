...
public sealed class RoomEntranceDunGen : IDunGenLayer, ISerializationGenerated<IDunGenLayer>, ISerializationGenerated, ISerializationGenerated<RoomEntranceDunGen>
{
	...
	public void InternalCopy(ref RoomEntranceDunGen target, ISerializationManager serialization, SerializationHookContext hookCtx, ISerializationContext? context = null)
	{
		...
		if (!serialization.TryCustomCopy<RoomEntranceDunGen>(this, ref target, hookCtx, false, context))
		{
	...
	[Obsolete("Use ISerializationManager.CopyTo instead")]
	public void Copy(ref RoomEntranceDunGen target, ISerializationManager serialization, SerializationHookContext hookCtx, ISerializationContext? context = null)
	{
	...
	{
		RoomEntranceDunGen cast = (RoomEntranceDunGen)target;
	...
	{
		RoomEntranceDunGen def = (RoomEntranceDunGen)target;
	...
	public RoomEntranceDunGen Instantiate()
	{
		return new RoomEntranceDunGen();
	}
