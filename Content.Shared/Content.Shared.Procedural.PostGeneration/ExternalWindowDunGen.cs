...
public sealed class ExternalWindowDunGen : IDunGenLayer, ISerializationGenerated<IDunGenLayer>, ISerializationGenerated, ISerializationGenerated<ExternalWindowDunGen>
{
	...
	public void InternalCopy(ref ExternalWindowDunGen target, ISerializationManager serialization, SerializationHookContext hookCtx, ISerializationContext? context = null)
	{
	...
	[Obsolete("Use ISerializationManager.CopyTo instead")]
	public void Copy(ref ExternalWindowDunGen target, ISerializationManager serialization, SerializationHookContext hookCtx, ISerializationContext? context = null)
	{
	...
	{
		ExternalWindowDunGen cast = (ExternalWindowDunGen)target;
	...
	{
		ExternalWindowDunGen def = (ExternalWindowDunGen)target;
	...
	public ExternalWindowDunGen Instantiate()
	{
		return new ExternalWindowDunGen();
	}
