...
public sealed class ConstructionPrototype : IPrototype, IInheritingPrototype, ICMSpecific
{
	...
	[DataField(null, false, 1, false, false, null)]
	public ProtoId<ConstructionPrototype>[] AlternativePrototypes = Array.Empty<ProtoId<ConstructionPrototype>>();

	[DataField(null, false, 1, false, false, null)]
	public Color IconColor = Color.FromHex((ReadOnlySpan<char>)"#ffffff", (Color?)null);
