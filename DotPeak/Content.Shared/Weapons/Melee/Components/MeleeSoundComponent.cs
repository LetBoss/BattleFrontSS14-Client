...
// Type: Content.Shared.Weapons.Melee.Components.MeleeSoundComponent
...
[RegisterComponent]
public sealed class MeleeSoundComponent : 
  Component,
  ISerializationGenerated<MeleeSoundComponent>,
  ISerializationGenerated
{
  ...
  public void InternalCopy(
    ref MeleeSoundComponent target,
    ...
    ISerializationContext? context = null)
  {
    ...
    target = (MeleeSoundComponent) target1;
    ...
    if (!serialization.TryCustomCopy<SoundSpecifier>(this.NoDamageSound, ref target4, hookCtx, true, context))
      target4 = serialization.CreateCopy<SoundSpecifier>(this.NoDamageSound, hookCtx, context);
    target.NoDamageSound = target4;
  }
  ...
  public override void Copy(
    ...
    ISerializationContext? context = null)
  {
    MeleeSoundComponent target1 = (MeleeSoundComponent) target;
  ...
  virtual MeleeSoundComponent Component.Instantiate() => new MeleeSoundComponent();
}
