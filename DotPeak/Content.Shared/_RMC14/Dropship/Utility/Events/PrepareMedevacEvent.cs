...
// Type: Content.Shared._RMC14.Dropship.Utility.Events.PrepareMedevacEvent
...
public sealed class PrepareMedevacEvent : EntityEventArgs
{
  ...
  public PrepareMedevacEvent(NetEntity medevacEntity) => this.MedevacEntity = medevacEntity;
}
