...
// Type: Content.Shared._RMC14.Roles.TotalJobsTimeRequirement
...
[NetSerializable]
[Serializable]
public sealed class TotalJobsTimeRequirement : 
  JobRequirement,
  ISerializationGenerated<TotalJobsTimeRequirement>,
  ISerializationGenerated
{
    ...
    IPrototypeManager prototypes)
  {
    ...
    JobGroupComponent component;
    if (!prototypes.Index(this.Group).TryGetComponent<JobGroupComponent>(out component, entManager.ComponentFactory))
    {
      Logger.GetSawmill("job.requirements").Error($"No {"DepartmentGroupComponent"} found on entity {this.Group}");
      return true;
    }
    foreach (ProtoId<JobPrototype> job in component.Jobs)
    {
      string playTimeTracker = prototypes.Index<JobPrototype>(job).PlayTimeTracker;
  ...
  public void InternalCopy(
    ref TotalJobsTimeRequirement target,
    ...
    ISerializationContext? context = null)
  {
    ...
    target = (TotalJobsTimeRequirement) target1;
  ...
  public override void Copy(
    ...
    ISerializationContext? context = null)
  {
    TotalJobsTimeRequirement target1 = (TotalJobsTimeRequirement) target;
  ...
  virtual TotalJobsTimeRequirement JobRequirement.Instantiate() => new TotalJobsTimeRequirement();
}
