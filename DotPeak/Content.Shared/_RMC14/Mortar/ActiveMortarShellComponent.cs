...
// Type: Content.Shared._RMC14.Mortar.ActiveMortarShellComponent
...
public sealed class ActiveMortarShellComponent : 
  Component,
  ISerializationGenerated<ActiveMortarShellComponent>,
  ISerializationGenerated
{
  ...
  public void InternalCopy(
    ref ActiveMortarShellComponent target,
    ...
    ISerializationContext? context = null)
  {
    ...
    target = (ActiveMortarShellComponent) target1;
  ...
  public override void Copy(
    ...
    ISerializationContext? context = null)
  {
    ActiveMortarShellComponent target1 = (ActiveMortarShellComponent) target;
  ...
  virtual ActiveMortarShellComponent Component.Instantiate() => new ActiveMortarShellComponent();
  ...
  public sealed class ActiveMortarShellComponent_AutoNetworkSystem : EntitySystem
  {
    ...
    {
      this.SubscribeLocalEvent<ActiveMortarShellComponent, ComponentGetState>(new ComponentEventRefHandler<ActiveMortarShellComponent, ComponentGetState>(this.OnGetState));
      this.SubscribeLocalEvent<ActiveMortarShellComponent, ComponentHandleState>(new ComponentEventRefHandler<ActiveMortarShellComponent, ComponentHandleState>(this.OnHandleState));
    }

    private void OnGetState(
      EntityUid uid,
      ActiveMortarShellComponent component,
      ref ComponentGetState args)
    {
      args.State = (IComponentState) new ActiveMortarShellComponent.ActiveMortarShellComponent_AutoState()
      {
    ...
    {
      if (!(args.Current is ActiveMortarShellComponent.ActiveMortarShellComponent_AutoState current))
        return;
      component.Coordinates = this.EnsureCoordinates<ActiveMortarShellComponent>(current.Coordinates, uid);
