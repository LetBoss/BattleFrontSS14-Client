...
// Type: Content.Shared.Procedural.PostGeneration.BiomeMarkerLayerDunGen
...
public sealed class BiomeMarkerLayerDunGen : 
  IDunGenLayer,
  ISerializationGenerated<IDunGenLayer>,
  ISerializationGenerated,
  ISerializationGenerated<BiomeMarkerLayerDunGen>
{
  ...
  public void InternalCopy(
    ref BiomeMarkerLayerDunGen target,
    ...
    ISerializationContext? context = null)
  {
    ...
    if (!serialization.TryCustomCopy<ProtoId<WeightedRandomPrototype>>(this.MarkerTemplate, ref target2, hookCtx, false, context))
      target2 = serialization.CreateCopy<ProtoId<WeightedRandomPrototype>>(this.MarkerTemplate, hookCtx, context);
    target.MarkerTemplate = target2;
  }
  ...
  public void Copy(
    ...
    ISerializationContext? context = null)
  {
    BiomeMarkerLayerDunGen target1 = (BiomeMarkerLayerDunGen) target;
  ...
  public BiomeMarkerLayerDunGen Instantiate() => new BiomeMarkerLayerDunGen();
