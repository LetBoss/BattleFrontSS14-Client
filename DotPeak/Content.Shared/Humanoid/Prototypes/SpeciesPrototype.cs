...
// Type: Content.Shared.Humanoid.Prototypes.SpeciesPrototype
...
public sealed class SpeciesPrototype : IPrototype
{
  ...
  [DataField(null, false, 1, false, false, null)]
  public ProtoId<LocalizedDatasetPrototype> MaleFirstNames { get; private set; } = (ProtoId<LocalizedDatasetPrototype>) "NamesFirstMale";

  [DataField(null, false, 1, false, false, null)]
  public ProtoId<LocalizedDatasetPrototype> FemaleFirstNames { get; private set; } = (ProtoId<LocalizedDatasetPrototype>) "NamesFirstFemale";

  [DataField(null, false, 1, false, false, null)]
  public ProtoId<LocalizedDatasetPrototype> LastNames { get; private set; } = (ProtoId<LocalizedDatasetPrototype>) "NamesLast";
