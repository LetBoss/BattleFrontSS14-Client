...
// Type: Content.Shared.Revolutionary.Components.HeadRevolutionaryComponent
...
public sealed class HeadRevolutionaryComponent : 
  Component,
  ISerializationGenerated<HeadRevolutionaryComponent>,
  ISerializationGenerated
{
  ...
  [DataField(null, false, 1, false, false, null)]
  [Robust.Shared.ViewVariables.ViewVariables(VVAccess.ReadWrite)]
  public ProtoId<FactionIconPrototype> StatusIcon { get; set; } = (ProtoId<FactionIconPrototype>) "HeadRevolutionaryFaction";

  public override bool SessionSpecific => true;

  [Obsolete("Use ISerializationManager.CopyTo instead")]
  public void InternalCopy(
    ref HeadRevolutionaryComponent target,
    ...
    ISerializationContext? context = null)
  {
    ...
    target = (HeadRevolutionaryComponent) target1;
  ...
  public override void Copy(
    ...
    ISerializationContext? context = null)
  {
    HeadRevolutionaryComponent target1 = (HeadRevolutionaryComponent) target;
  ...
  virtual HeadRevolutionaryComponent Component.Instantiate() => new HeadRevolutionaryComponent();
}
