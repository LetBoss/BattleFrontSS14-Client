...
// Type: Content.Shared.Lock.LockingWhitelistComponent
...
[RegisterComponent]
[NetworkedComponent]
[Access(new Type[] {typeof (LockingWhitelistSystem)})]
public sealed class LockingWhitelistComponent : 
  Component,
  ISerializationGenerated<LockingWhitelistComponent>,
  ISerializationGenerated
{
  ...
  public void InternalCopy(
    ref LockingWhitelistComponent target,
    ...
    ISerializationContext? context = null)
  {
    ...
    target = (LockingWhitelistComponent) target1;
    if (serialization.TryCustomCopy<LockingWhitelistComponent>(this, ref target, hookCtx, false, context))
      return;
  ...
  public override void Copy(
    ...
    ISerializationContext? context = null)
  {
    LockingWhitelistComponent target1 = (LockingWhitelistComponent) target;
  ...
  virtual LockingWhitelistComponent Component.Instantiate() => new LockingWhitelistComponent();
}
