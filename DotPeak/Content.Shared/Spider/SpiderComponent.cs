...
// Type: Content.Shared.Spider.SpiderComponent
...
public sealed class SpiderComponent : 
  Component,
  ISerializationGenerated<SpiderComponent>,
  ISerializationGenerated
{
    ...
    ISerializationContext? context = null)
  {
    ...
    target = (SpiderComponent) target1;
    if (serialization.TryCustomCopy<SpiderComponent>(this, ref target, hookCtx, false, context))
      return;
    string target2 = (string) null;
    if (this.WebPrototype == null)
      throw new NullNotAllowedException();
    if (!serialization.TryCustomCopy<string>(this.WebPrototype, ref target2, hookCtx, false, context))
      target2 = this.WebPrototype;
    target.WebPrototype = target2;
    string target3 = (string) null;
    if (this.WebAction == null)
      throw new NullNotAllowedException();
    if (!serialization.TryCustomCopy<string>(this.WebAction, ref target3, hookCtx, false, context))
      target3 = this.WebAction;
    target.WebAction = target3;
  ...
  public override void Copy(
    ...
    ISerializationContext? context = null)
  {
    SpiderComponent target1 = (SpiderComponent) target;
  ...
  virtual SpiderComponent Component.Instantiate() => new SpiderComponent();
}
