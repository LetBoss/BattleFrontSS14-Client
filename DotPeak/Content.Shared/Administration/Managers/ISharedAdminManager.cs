...
// Type: Content.Shared.Administration.Managers.ISharedAdminManager
...
public interface ISharedAdminManager
{
  ...
  {
    AdminData adminData = this.GetAdminData(player, includeDeAdmin);
    return adminData != null && adminData.HasFlag(flag, includeDeAdmin);
  }
  ...
  {
    return this.GetAdminData(uid, includeDeAdmin) != null;
  }
