...
// Type: Content.Shared._CIV14merka.Damage.CivDamageSlowdownSystem
...
public sealed class CivDamageSlowdownSystem : EntitySystem
{
  ...
  {
    base.Initialize();
    this.SubscribeLocalEvent<CivTeamMemberComponent, ModifySlowOnDamageSpeedEvent>(new EntityEventRefHandler<CivTeamMemberComponent, ModifySlowOnDamageSpeedEvent>(this.OnModifySlowOnDamageSpeed), after: new Type[1]
    {
