...
// Type: Content.Shared._CIV14merka.Specialist.CivSpecialistSetInfo
...
[DataDefinition]
[Serializable]
public struct CivSpecialistSetInfo : 
  ISerializationGenerated<CivSpecialistSetInfo>,
  ISerializationGenerated
{
  ...
  public void InternalCopy(
    ref CivSpecialistSetInfo target,
  ...
  public void Copy(
    ...
    ISerializationContext? context = null)
  {
    CivSpecialistSetInfo target1 = (CivSpecialistSetInfo) target;
    this.Copy(ref target1, serialization, hookCtx, context);
    target = (object) target1;
  }

  [Obsolete("Use ISerializationManager.CreateCopy instead")]
  public CivSpecialistSetInfo Instantiate() => new CivSpecialistSetInfo();
}
