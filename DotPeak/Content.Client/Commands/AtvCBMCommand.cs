...
// Type: Content.Client.Commands.AtvCBMCommand
...
internal sealed class AtvCBMCommand : LocalizedCommands
{
  ...
  public virtual string Command => "atvcbm";
  ...
  public virtual void Execute(IConsoleShell shell, string argStr, string[] args)
  {
    ...
    else
    {
      ...
      if (!bool.TryParse(args[0], out result))
        ...
        this._entitySystemManager.GetEntitySystem<AtmosDebugOverlaySystem>().CfgCBM = result;
    }
  }
}
