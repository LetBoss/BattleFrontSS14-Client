...
// Type: Content.Client.Commands.ShowMarkersCommand
...
internal sealed class ShowMarkersCommand : LocalizedCommands
{
  ...
  public virtual string Command => "showmarkers";
  ...
  {
    MarkerSystem entitySystem = this._entitySystemManager.GetEntitySystem<MarkerSystem>();
