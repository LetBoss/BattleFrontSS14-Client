...
// Type: Content.Client._RMC14.Xenonids.Acider.XenoAciderGenerationVisualsSystem
...
public sealed class XenoAciderGenerationVisualsSystem : 
  VisualizerSystem<XenoAciderGenerationComponent>
{
    ...
    ref AppearanceChangeEvent args)
  {
    ...
    bool flag1;
    int num;
    if (sprite == null || !((SharedAppearanceSystem) this.AppearanceSystem).TryGetData<bool>(uid, (Enum) XenoAcidGeneratingVisuals.Generating, ref flag1, (AppearanceComponent) null) || !this.SpriteSystem.LayerMapTryGet(Entity<SpriteComponent>.op_Implicit((uid, sprite)), (Enum) XenoAcidGeneratingVisualLayers.Base, ref num, false))
      return;
    if (!flag1)
    {
