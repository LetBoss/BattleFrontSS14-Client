...
// Type: Content.Client.Lightning.Components.LightningComponent
...
public sealed class LightningComponent : 
  SharedLightningComponent,
  ISerializationGenerated<LightningComponent>,
  ISerializationGenerated
{
  [Obsolete("Use ISerializationManager.CopyTo instead")]
  public void InternalCopy(
    ref LightningComponent target,
    ...
    ISerializationContext? context = null)
  {
    ...
    target = (LightningComponent) target1;
  ...
  public override void Copy(
    ...
    ISerializationContext? context = null)
  {
    LightningComponent target1 = (LightningComponent) target;
  ...
  virtual LightningComponent SharedLightningComponent.Instantiate() => new LightningComponent();
}
