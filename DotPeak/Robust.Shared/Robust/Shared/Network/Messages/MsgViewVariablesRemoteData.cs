...
// Type: Robust.Shared.Network.Messages.MsgViewVariablesRemoteData
...
public sealed class MsgViewVariablesRemoteData : NetMessage
{
  ...
  public override void ReadFromBuffer(NetIncomingMessage buffer, IRobustSerializer serializer)
  {
    ...
    using (MemoryStream memoryStream = RobustMemoryManager.GetMemoryStream(length))
    {
      ...
      this.Blob = serializer.Deserialize<ViewVariablesBlob>((Stream) memoryStream);
    }
  }
  ...
  public override void WriteToBuffer(NetOutgoingMessage buffer, IRobustSerializer serializer)
  {
    ...
    serializer.Serialize((Stream) ms, (object) this.Blob);
