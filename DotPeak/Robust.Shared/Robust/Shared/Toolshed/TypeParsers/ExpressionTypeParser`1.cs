...
// Type: Robust.Shared.Toolshed.TypeParsers.ExpressionTypeParser`1
...
internal sealed class ExpressionTypeParser<T> : TypeParser<CommandRun<T>>
{
  ...
  {
    return CommandRun<T>.TryParse(ctx, (Type) null, out result);
  }

  public override CompletionResult? TryAutocomplete(ParserContext ctx, CommandArgument? arg)
  {
    CommandRun<T>.TryParse(ctx, (Type) null, out CommandRun<T> _);
