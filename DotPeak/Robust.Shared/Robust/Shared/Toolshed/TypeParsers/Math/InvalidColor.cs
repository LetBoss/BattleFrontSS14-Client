...
// Type: Robust.Shared.Toolshed.TypeParsers.Math.InvalidColor
...
public record InvalidColor(string Value) : IConError
{
  ...
  {
    return FormattedMessage.FromUnformatted($"The value {this.Value} is not a valid RGB color or name of color.");
  }
