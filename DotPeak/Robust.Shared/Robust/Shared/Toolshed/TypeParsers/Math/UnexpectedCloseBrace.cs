...
// Type: Robust.Shared.Toolshed.TypeParsers.Math.UnexpectedCloseBrace
...
public record UnexpectedCloseBrace() : IConError
{
  ...
  [CompilerGenerated]
  public virtual bool Equals(UnexpectedCloseBrace? other)
  {
  ...
  [CompilerGenerated]
  protected UnexpectedCloseBrace(UnexpectedCloseBrace original)
  {
    // ISSUE: reference to a compiler-generated field
    // ISSUE: reference to a compiler-generated field
