...
// Type: Robust.Shared.Toolshed.TypeParsers.Math.ExpectedCloseBrace
...
public record ExpectedCloseBrace() : IConError
{
  ...
  [CompilerGenerated]
  public virtual bool Equals(ExpectedCloseBrace? other)
  {
  ...
  [CompilerGenerated]
  protected ExpectedCloseBrace(ExpectedCloseBrace original)
  {
    // ISSUE: reference to a compiler-generated field
    // ISSUE: reference to a compiler-generated field
