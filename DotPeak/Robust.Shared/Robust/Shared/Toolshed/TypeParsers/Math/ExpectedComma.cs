...
// Type: Robust.Shared.Toolshed.TypeParsers.Math.ExpectedComma
...
public record ExpectedComma() : IConError
{
  ...
  [CompilerGenerated]
  public virtual bool Equals(ExpectedComma? other)
  {
  ...
  [CompilerGenerated]
  protected ExpectedComma(ExpectedComma original)
  {
    // ISSUE: reference to a compiler-generated field
    // ISSUE: reference to a compiler-generated field
