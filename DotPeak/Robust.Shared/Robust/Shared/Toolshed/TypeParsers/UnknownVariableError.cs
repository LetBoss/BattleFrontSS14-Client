...
// Type: Robust.Shared.Toolshed.TypeParsers.UnknownVariableError
...
public record UnknownVariableError(string VarName) : IConError
{
  ...
  {
    return FormattedMessage.FromUnformatted($"Unknown variable '${this.VarName}'. Cannot infer type. Consider using {"ValCommand"} and explicitly specifying the type.");
  }
