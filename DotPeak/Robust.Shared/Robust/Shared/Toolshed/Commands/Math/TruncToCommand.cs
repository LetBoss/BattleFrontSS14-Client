...
// Type: Robust.Shared.Toolshed.Commands.Math.TruncToCommand
...
public sealed class TruncToCommand : ToolshedCommand
{
  ...
  public override Type[] TypeParameterParsers => TruncToCommand._parsers;
  ...
  {
    return TOut.CreateTruncating<T>(x);
  }
