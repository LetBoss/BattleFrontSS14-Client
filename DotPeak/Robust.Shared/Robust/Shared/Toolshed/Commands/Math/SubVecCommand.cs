...
// Type: Robust.Shared.Toolshed.Commands.Math.SubVecCommand
...
public sealed class SubVecCommand : ToolshedCommand
{
  ...
  public IEnumerable<T> Operation<T>([PipedArgument] IEnumerable<T> x, T y) where T : ISubtractionOperators<T, T, T>
  {
