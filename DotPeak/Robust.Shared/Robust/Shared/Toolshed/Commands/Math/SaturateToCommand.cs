...
// Type: Robust.Shared.Toolshed.Commands.Math.SaturateToCommand
...
public sealed class SaturateToCommand : ToolshedCommand
{
  ...
  public override Type[] TypeParameterParsers => SaturateToCommand._parsers;
  ...
  {
    return TOut.CreateSaturating<T>(x);
  }
