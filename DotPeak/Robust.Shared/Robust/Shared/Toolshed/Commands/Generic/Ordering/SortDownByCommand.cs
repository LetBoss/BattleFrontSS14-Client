...
// Type: Robust.Shared.Toolshed.Commands.Generic.Ordering.SortDownByCommand
...
public sealed class SortDownByCommand : ToolshedCommand
{
  ...
  public override Type[] TypeParameterParsers => SortDownByCommand._parsers;
  ...
  {
    return (IEnumerable<T>) input.OrderByDescending<T, TOrd>((Func<T, TOrd>) (x => orderer.Invoke(x, ctx)));
  }
}
