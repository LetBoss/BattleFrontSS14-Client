...
// Type: Robust.Shared.GameObjects.AllEntityQueryEnumerator`1
...
public struct AllEntityQueryEnumerator<TComp1> : IDisposable where TComp1 : IComponent
{
  private Dictionary<EntityUid, IComponent>.Enumerator _traitDict;

  public AllEntityQueryEnumerator(Dictionary<EntityUid, IComponent> traitDict)
  {
