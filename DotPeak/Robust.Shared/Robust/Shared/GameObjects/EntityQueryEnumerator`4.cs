...
// Type: Robust.Shared.GameObjects.EntityQueryEnumerator`4
  ...
  where TComp4 : IComponent
{
    ...
    [NotNullWhen(true)] out TComp4? comp4)
  {
    while (this._traitDict.MoveNext())
    {
      ...
      if (!current.Value.Deleted && this._metaQuery.TryGetComponentInternal(current.Key, out component1) && !component1.EntityPaused && this._traitDict2.TryGetValue(current.Key, out component2) && !component2.Deleted && this._traitDict3.TryGetValue(current.Key, out component3) && !component3.Deleted && this._traitDict4.TryGetValue(current.Key, out component4) && !component4.Deleted)
      {
        uid = current.Key;
        comp1 = (TComp1) current.Value;
        comp2 = (TComp2) component2;
        comp3 = (TComp3) component3;
        comp4 = (TComp4) component4;
        return true;
      }
    }
    uid = new EntityUid();
  ...
  {
    return this.MoveNext(out EntityUid _, out comp1, out comp2, out comp3, out comp4);
  }
