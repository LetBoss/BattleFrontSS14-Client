...
// Type: Robust.Shared.Noise.FastNoiseLite
...
public sealed class FastNoiseLite : 
  ISerializationHooks,
  ISerializationGenerated<FastNoiseLite>,
  ISerializationGenerated
{
  private const short INLINE = 256 /*0x0100*/;
  private const short OPTIMISE = 512 /*0x0200*/;
  ...
  private static readonly float[] Gradients2D = new float[256 /*0x0100*/]
  {
    0.130526185f,
    0.9914449f,
    0.382683426f,
  ...
  private static readonly float[] RandVecs2D = new float[512 /*0x0200*/]
  {
    -0.2700222f,
    -0.9628541f,
    0.386309266f,
  ...
  private static readonly float[] Gradients3D = new float[256 /*0x0100*/]
  {
    0.0f,
    1f,
    1f,
  ...
  private static readonly float[] RandVecs3D = new float[1024 /*0x0400*/]
  {
    -0.7292737f,
    -0.661843956f,
    0.17355819f,
  ...
  public FastNoiseLite(int seed) => this.SetSeed(seed);

  public FastNoiseLite() => this.SetSeed(1337);

  void ISerializationHooks.AfterDeserialization() => this.CalculateFractalBounding();

  public int GetSeed() => this.mSeed;

  public void SetSeed(int seed) => this.mSeed = seed;

  public float GetFrequency() => this.mFrequency;

  public void SetFrequency(float frequency) => this.mFrequency = frequency;

  public FastNoiseLite.NoiseType GetNoiseType() => this.mNoiseType;
  ...
  public FastNoiseLite.RotationType3D GetRotationType3D() => this.mRotationType3D;
  ...
  public FastNoiseLite.FractalType GetFractalType() => this.mFractalType;
  ...
  public int GetFractalOctaves() => this.mOctaves;

  public void SetFractalLacunarity(float lacunarity) => this.mLacunarity = lacunarity;

  public float GetFractalLacunarity() => this.mLacunarity;
  ...
  public FastNoiseLite.CellularReturnType GetCellularReturnType() => this.mCellularReturnType;
  ...
  public float GetCellularJitter() => this.mCellularJitterModifier;
  ...
  {
    if ((uint) this.mDomainWarpType > 1U)
      return;
    float num = (float) (((double) x + (double) y) * 0.36602538824081421);
    x += num;
    y += num;
  ...
  public void InternalCopy(
    ref FastNoiseLite target,
    ISerializationManager serialization,
    SerializationHookContext hookCtx,
    ISerializationContext? context = null)
  {
    if (serialization.TryCustomCopy<FastNoiseLite>(this, ref target, hookCtx, true, context))
      return;
    int target1 = 0;
    if (!serialization.TryCustomCopy<int>(this.mSeed, ref target1, hookCtx, false, context))
      target1 = this.mSeed;
    target.mSeed = target1;
    float target2 = 0.0f;
    if (!serialization.TryCustomCopy<float>(this.mFrequency, ref target2, hookCtx, false, context))
      target2 = this.mFrequency;
    target.mFrequency = target2;
    FastNoiseLite.NoiseType target3 = FastNoiseLite.NoiseType.OpenSimplex2;
    if (!serialization.TryCustomCopy<FastNoiseLite.NoiseType>(this.mNoiseType, ref target3, hookCtx, false, context))
      target3 = this.mNoiseType;
    target.mNoiseType = target3;
    FastNoiseLite.RotationType3D target4 = FastNoiseLite.RotationType3D.None;
    if (!serialization.TryCustomCopy<FastNoiseLite.RotationType3D>(this.mRotationType3D, ref target4, hookCtx, false, context))
      target4 = this.mRotationType3D;
    target.mRotationType3D = target4;
    FastNoiseLite.TransformType3D target5 = FastNoiseLite.TransformType3D.None;
    if (!serialization.TryCustomCopy<FastNoiseLite.TransformType3D>(this.mTransformType3D, ref target5, hookCtx, false, context))
      target5 = this.mTransformType3D;
    target.mTransformType3D = target5;
    FastNoiseLite.FractalType target6 = FastNoiseLite.FractalType.None;
    if (!serialization.TryCustomCopy<FastNoiseLite.FractalType>(this.mFractalType, ref target6, hookCtx, false, context))
      target6 = this.mFractalType;
    target.mFractalType = target6;
    int target7 = 0;
    if (!serialization.TryCustomCopy<int>(this.mOctaves, ref target7, hookCtx, false, context))
      target7 = this.mOctaves;
    target.mOctaves = target7;
    float target8 = 0.0f;
    if (!serialization.TryCustomCopy<float>(this.mLacunarity, ref target8, hookCtx, false, context))
      target8 = this.mLacunarity;
    target.mLacunarity = target8;
    float target9 = 0.0f;
    if (!serialization.TryCustomCopy<float>(this.mGain, ref target9, hookCtx, false, context))
      target9 = this.mGain;
    target.mGain = target9;
    float target10 = 0.0f;
    if (!serialization.TryCustomCopy<float>(this.mWeightedStrength, ref target10, hookCtx, false, context))
      target10 = this.mWeightedStrength;
    target.mWeightedStrength = target10;
    float target11 = 0.0f;
    if (!serialization.TryCustomCopy<float>(this.mPingPongStrength, ref target11, hookCtx, false, context))
      target11 = this.mPingPongStrength;
    target.mPingPongStrength = target11;
    FastNoiseLite.CellularDistanceFunction target12 = FastNoiseLite.CellularDistanceFunction.Euclidean;
    if (!serialization.TryCustomCopy<FastNoiseLite.CellularDistanceFunction>(this.mCellularDistanceFunction, ref target12, hookCtx, false, context))
      target12 = this.mCellularDistanceFunction;
    target.mCellularDistanceFunction = target12;
    FastNoiseLite.CellularReturnType target13 = FastNoiseLite.CellularReturnType.CellValue;
    if (!serialization.TryCustomCopy<FastNoiseLite.CellularReturnType>(this.mCellularReturnType, ref target13, hookCtx, false, context))
      target13 = this.mCellularReturnType;
    target.mCellularReturnType = target13;
    float target14 = 0.0f;
    if (!serialization.TryCustomCopy<float>(this.mCellularJitterModifier, ref target14, hookCtx, false, context))
      target14 = this.mCellularJitterModifier;
    target.mCellularJitterModifier = target14;
    FastNoiseLite.DomainWarpType target15 = FastNoiseLite.DomainWarpType.OpenSimplex2;
    if (!serialization.TryCustomCopy<FastNoiseLite.DomainWarpType>(this.mDomainWarpType, ref target15, hookCtx, false, context))
      target15 = this.mDomainWarpType;
    target.mDomainWarpType = target15;
    FastNoiseLite.TransformType3D target16 = FastNoiseLite.TransformType3D.None;
    if (!serialization.TryCustomCopy<FastNoiseLite.TransformType3D>(this.mWarpTransformType3D, ref target16, hookCtx, false, context))
      target16 = this.mWarpTransformType3D;
    target.mWarpTransformType3D = target16;
    float target17 = 0.0f;
    if (!serialization.TryCustomCopy<float>(this.mDomainWarpAmp, ref target17, hookCtx, false, context))
      target17 = this.mDomainWarpAmp;
    target.mDomainWarpAmp = target17;
  }
  ...
  public void Copy(
    ...
    ISerializationContext? context = null)
  {
    FastNoiseLite target1 = (FastNoiseLite) target;
    this.Copy(ref target1, serialization, hookCtx, context);
    target = (object) target1;
  }

  [Obsolete("Use ISerializationManager.CreateCopy instead")]
  public FastNoiseLite Instantiate() => new FastNoiseLite();
