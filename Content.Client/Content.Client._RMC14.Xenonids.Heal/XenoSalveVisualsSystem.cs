...
public sealed class XenoSalveVisualsSystem : VisualizerSystem<XenoSalveVisualsComponent>
{
	protected override void OnAppearanceChange(EntityUid uid, XenoSalveVisualsComponent component, ref AppearanceChangeEvent args)
	{
		...
		int num = default(int);
		if (sprite == null || !((SharedAppearanceSystem)base.AppearanceSystem).TryGetData<bool>(uid, (Enum)XenoHealerVisuals.Gooped, ref flag, (AppearanceComponent)null) || !base.SpriteSystem.LayerMapTryGet(Entity<SpriteComponent>.op_Implicit((uid, sprite)), (Enum)XenoHealerVisualLayers.Goop, ref num, false))
		{
			return;
		}
		if (!flag)
