...
internal sealed class SpecificFieldInfo : AbstractFieldInfo
{
	...
	{
		return FieldInfo.TryGetCustomAttribute<T>(out attribute);
	}
	...
	public static implicit operator FieldInfo(SpecificFieldInfo f)
	{
		return f.FieldInfo;
	}

	public static explicit operator SpecificFieldInfo(FieldInfo f)
	{
		return new SpecificFieldInfo(f);
	}
