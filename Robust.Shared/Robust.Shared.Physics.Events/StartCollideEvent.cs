...
public readonly struct StartCollideEvent
{
	...
	public Vector2[] WorldPoints => _worldPoints.AsSpan.Slice(0, PointCount).ToArray();

	internal StartCollideEvent(EntityUid ourEntity, EntityUid otherEntity, string ourFixtureId, string otherFixtureId, Fixture ourFixture, Fixture otherFixture, PhysicsComponent ourBody, PhysicsComponent otherBody, FixedArray2<Vector2> worldPoints, int pointCount, Vector2 worldNormal)
	{
		OurEntity = ourEntity;
