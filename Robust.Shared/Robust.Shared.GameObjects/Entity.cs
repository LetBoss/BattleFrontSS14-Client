...
[NotYamlSerializable]
public record struct Entity<T> : IFluentEntityUid, IAsType<EntityUid> where T : IComponent?
{
	...
	{
		return new Entity<T>(owner, default(T));
	}
	...
	public readonly Entity<T?> AsNullable()
	{
		return new Entity<T>(Owner, Comp);
	}

	public readonly EntityUid AsType()
	{
		return Owner;
	}
}
[NotYamlSerializable]
public record struct Entity<T1, T2> : IFluentEntityUid, IAsType<EntityUid> where T1 : IComponent? where T2 : IComponent?
{
	readonly EntityUid IFluentEntityUid.FluentOwner => Owner;
	...
	{
		return new Entity<T1, T2>(Owner, Comp1, Comp2);
	}
...
[NotYamlSerializable]
public record struct Entity<T1, T2, T3> : IFluentEntityUid, IAsType<EntityUid> where T1 : IComponent? where T2 : IComponent? where T3 : IComponent?
{
	readonly EntityUid IFluentEntityUid.FluentOwner => Owner;
	...
	{
		return new Entity<T1, T2, T3>(owner, default(T1), default(T2), default(T3));
	}
	...
	{
		return new Entity<T1, T2, T3>(tuple.Owner, tuple.Comp1, default(T2), default(T3));
	}

	public static implicit operator Entity<T1, T2, T3?>((EntityUid Owner, T1 Comp1, T2 Comp2) tuple)
	{
		return new Entity<T1, T2, T3>(tuple.Owner, tuple.Comp1, tuple.Comp2, default(T3));
	}

	public static implicit operator Entity<T1, T2?, T3?>(Entity<T1> ent)
	{
		return new Entity<T1, T2, T3>(ent.Owner, ent.Comp, default(T2), default(T3));
	}

	public static implicit operator Entity<T1, T2, T3?>(Entity<T1, T2> ent)
	{
		return new Entity<T1, T2, T3>(ent.Owner, ent.Comp1, ent.Comp2, default(T3));
	}
	...
	public readonly Entity<T1?, T2?, T3?> AsNullable()
	{
		return new Entity<T1, T2, T3>(Owner, Comp1, Comp2, Comp3);
	}
...
[NotYamlSerializable]
public record struct Entity<T1, T2, T3, T4> : IFluentEntityUid, IAsType<EntityUid> where T1 : IComponent? where T2 : IComponent? where T3 : IComponent? where T4 : IComponent?
{
	readonly EntityUid IFluentEntityUid.FluentOwner => Owner;
	...
	{
		return new Entity<T1, T2, T3, T4>(Owner, Comp1, Comp2, Comp3, Comp4);
	}
...
[NotYamlSerializable]
public record struct Entity<T1, T2, T3, T4, T5> : IFluentEntityUid, IAsType<EntityUid> where T1 : IComponent? where T2 : IComponent? where T3 : IComponent? where T4 : IComponent? where T5 : IComponent?
{
	readonly EntityUid IFluentEntityUid.FluentOwner => Owner;
	...
	{
		return new Entity<T1, T2, T3, T4, T5>(owner, default(T1), default(T2), default(T3), default(T4), default(T5));
	}
	...
	{
		return new Entity<T1, T2, T3, T4, T5>(tuple.Owner, tuple.Comp1, default(T2), default(T3), default(T4), default(T5));
	}

	public static implicit operator Entity<T1, T2, T3?, T4?, T5?>((EntityUid Owner, T1 Comp1, T2 Comp2) tuple)
	{
		return new Entity<T1, T2, T3, T4, T5>(tuple.Owner, tuple.Comp1, tuple.Comp2, default(T3), default(T4), default(T5));
	}

	public static implicit operator Entity<T1, T2, T3, T4?, T5?>((EntityUid Owner, T1 Comp1, T2 Comp2, T3 Comp3) tuple)
	{
		return new Entity<T1, T2, T3, T4, T5>(tuple.Owner, tuple.Comp1, tuple.Comp2, tuple.Comp3, default(T4), default(T5));
	}

	public static implicit operator Entity<T1, T2, T3, T4, T5?>((EntityUid Owner, T1 Comp1, T2 Comp2, T3 Comp3, T4 Comp4) tuple)
	{
		return new Entity<T1, T2, T3, T4, T5>(tuple.Owner, tuple.Comp1, tuple.Comp2, tuple.Comp3, tuple.Comp4, default(T5));
	}

	public static implicit operator Entity<T1, T2?, T3?, T4?, T5?>(Entity<T1> ent)
	{
		return new Entity<T1, T2, T3, T4, T5>(ent.Owner, ent.Comp, default(T2), default(T3), default(T4), default(T5));
	}

	public static implicit operator Entity<T1, T2, T3?, T4?, T5?>(Entity<T1, T2> ent)
	{
		return new Entity<T1, T2, T3, T4, T5>(ent.Owner, ent.Comp1, ent.Comp2, default(T3), default(T4), default(T5));
	}

	public static implicit operator Entity<T1, T2, T3, T4?, T5?>(Entity<T1, T2, T3> ent)
	{
		return new Entity<T1, T2, T3, T4, T5>(ent.Owner, ent.Comp1, ent.Comp2, ent.Comp3, default(T4), default(T5));
	}

	public static implicit operator Entity<T1, T2, T3, T4, T5?>(Entity<T1, T2, T3, T4> ent)
	{
		return new Entity<T1, T2, T3, T4, T5>(ent.Owner, ent.Comp1, ent.Comp2, ent.Comp3, ent.Comp4, default(T5));
	}
	...
	public readonly Entity<T1?, T2?, T3?, T4?, T5?> AsNullable()
	{
		return new Entity<T1, T2, T3, T4, T5>(Owner, Comp1, Comp2, Comp3, Comp4, Comp5);
	}
...
[NotYamlSerializable]
public record struct Entity<T1, T2, T3, T4, T5, T6> : IFluentEntityUid, IAsType<EntityUid> where T1 : IComponent? where T2 : IComponent? where T3 : IComponent? where T4 : IComponent? where T5 : IComponent? where T6 : IComponent?
{
	readonly EntityUid IFluentEntityUid.FluentOwner => Owner;
	...
	{
		return new Entity<T1, T2, T3, T4, T5, T6>(owner, default(T1), default(T2), default(T3), default(T4), default(T5), default(T6));
	}
	...
	{
		return new Entity<T1, T2, T3, T4, T5, T6>(tuple.Owner, tuple.Comp1, default(T2), default(T3), default(T4), default(T5), default(T6));
	}

	public static implicit operator Entity<T1, T2, T3?, T4?, T5?, T6?>((EntityUid Owner, T1 Comp1, T2 Comp2) tuple)
	{
		return new Entity<T1, T2, T3, T4, T5, T6>(tuple.Owner, tuple.Comp1, tuple.Comp2, default(T3), default(T4), default(T5), default(T6));
	}

	public static implicit operator Entity<T1, T2, T3, T4?, T5?, T6?>((EntityUid Owner, T1 Comp1, T2 Comp2, T3 Comp3) tuple)
	{
		return new Entity<T1, T2, T3, T4, T5, T6>(tuple.Owner, tuple.Comp1, tuple.Comp2, tuple.Comp3, default(T4), default(T5), default(T6));
	}

	public static implicit operator Entity<T1, T2, T3, T4, T5?, T6?>((EntityUid Owner, T1 Comp1, T2 Comp2, T3 Comp3, T4 Comp4) tuple)
	{
		return new Entity<T1, T2, T3, T4, T5, T6>(tuple.Owner, tuple.Comp1, tuple.Comp2, tuple.Comp3, tuple.Comp4, default(T5), default(T6));
	}
	...
	{
		return new Entity<T1, T2, T3, T4, T5, T6>(tuple.Owner, tuple.Comp1, tuple.Comp2, tuple.Comp3, tuple.Comp4, tuple.Comp5, default(T6));
	}

	public static implicit operator Entity<T1, T2?, T3?, T4?, T5?, T6?>(Entity<T1> ent)
	{
		return new Entity<T1, T2, T3, T4, T5, T6>(ent.Owner, ent.Comp, default(T2), default(T3), default(T4), default(T5), default(T6));
	}

	public static implicit operator Entity<T1, T2, T3?, T4?, T5?, T6?>(Entity<T1, T2> ent)
	{
		return new Entity<T1, T2, T3, T4, T5, T6>(ent.Owner, ent.Comp1, ent.Comp2, default(T3), default(T4), default(T5), default(T6));
	}

	public static implicit operator Entity<T1, T2, T3, T4?, T5?, T6?>(Entity<T1, T2, T3> ent)
	{
		return new Entity<T1, T2, T3, T4, T5, T6>(ent.Owner, ent.Comp1, ent.Comp2, ent.Comp3, default(T4), default(T5), default(T6));
	}

	public static implicit operator Entity<T1, T2, T3, T4, T5?, T6?>(Entity<T1, T2, T3, T4> ent)
	{
		return new Entity<T1, T2, T3, T4, T5, T6>(ent.Owner, ent.Comp1, ent.Comp2, ent.Comp3, ent.Comp4, default(T5), default(T6));
	}

	public static implicit operator Entity<T1, T2, T3, T4, T5, T6?>(Entity<T1, T2, T3, T4, T5> ent)
	{
		return new Entity<T1, T2, T3, T4, T5, T6>(ent.Owner, ent.Comp1, ent.Comp2, ent.Comp3, ent.Comp4, ent.Comp5, default(T6));
	}
	...
	public readonly Entity<T1?, T2?, T3?, T4?, T5?, T6?> AsNullable()
	{
		return new Entity<T1, T2, T3, T4, T5, T6>(Owner, Comp1, Comp2, Comp3, Comp4, Comp5, Comp6);
	}
...
[NotYamlSerializable]
public record struct Entity<T1, T2, T3, T4, T5, T6, T7> : IFluentEntityUid, IAsType<EntityUid> where T1 : IComponent? where T2 : IComponent? where T3 : IComponent? where T4 : IComponent? where T5 : IComponent? where T6 : IComponent? where T7 : IComponent?
{
	readonly EntityUid IFluentEntityUid.FluentOwner => Owner;
	...
	{
		return new Entity<T1, T2, T3, T4, T5, T6, T7>(tuple.Owner, tuple.Comp1, tuple.Comp2, tuple.Comp3, tuple.Comp4, tuple.Comp5, tuple.Comp6, tuple.Rest.Item1);
	}

	public static implicit operator Entity<T1?, T2?, T3?, T4?, T5?, T6?, T7?>(EntityUid owner)
	{
		return new Entity<T1, T2, T3, T4, T5, T6, T7>(owner, default(T1), default(T2), default(T3), default(T4), default(T5), default(T6), default(T7));
	}
	...
	{
		return new Entity<T1, T2, T3, T4, T5, T6, T7>(tuple.Owner, tuple.Comp1, default(T2), default(T3), default(T4), default(T5), default(T6), default(T7));
	}

	public static implicit operator Entity<T1, T2, T3?, T4?, T5?, T6?, T7?>((EntityUid Owner, T1 Comp1, T2 Comp2) tuple)
	{
		return new Entity<T1, T2, T3, T4, T5, T6, T7>(tuple.Owner, tuple.Comp1, tuple.Comp2, default(T3), default(T4), default(T5), default(T6), default(T7));
	}

	public static implicit operator Entity<T1, T2, T3, T4?, T5?, T6?, T7?>((EntityUid Owner, T1 Comp1, T2 Comp2, T3 Comp3) tuple)
	{
		return new Entity<T1, T2, T3, T4, T5, T6, T7>(tuple.Owner, tuple.Comp1, tuple.Comp2, tuple.Comp3, default(T4), default(T5), default(T6), default(T7));
	}

	public static implicit operator Entity<T1, T2, T3, T4, T5?, T6?, T7?>((EntityUid Owner, T1 Comp1, T2 Comp2, T3 Comp3, T4 Comp4) tuple)
	{
		return new Entity<T1, T2, T3, T4, T5, T6, T7>(tuple.Owner, tuple.Comp1, tuple.Comp2, tuple.Comp3, tuple.Comp4, default(T5), default(T6), default(T7));
	}
	...
	{
		return new Entity<T1, T2, T3, T4, T5, T6, T7>(tuple.Owner, tuple.Comp1, tuple.Comp2, tuple.Comp3, tuple.Comp4, tuple.Comp5, default(T6), default(T7));
	}
	...
	{
		return new Entity<T1, T2, T3, T4, T5, T6, T7>(tuple.Owner, tuple.Comp1, tuple.Comp2, tuple.Comp3, tuple.Comp4, tuple.Comp5, tuple.Comp6, default(T7));
	}

	public static implicit operator Entity<T1, T2?, T3?, T4?, T5?, T6?, T7?>(Entity<T1> ent)
	{
		return new Entity<T1, T2, T3, T4, T5, T6, T7>(ent.Owner, ent.Comp, default(T2), default(T3), default(T4), default(T5), default(T6), default(T7));
	}

	public static implicit operator Entity<T1, T2, T3?, T4?, T5?, T6?, T7?>(Entity<T1, T2> ent)
	{
		return new Entity<T1, T2, T3, T4, T5, T6, T7>(ent.Owner, ent.Comp1, ent.Comp2, default(T3), default(T4), default(T5), default(T6), default(T7));
	}

	public static implicit operator Entity<T1, T2, T3, T4?, T5?, T6?, T7?>(Entity<T1, T2, T3> ent)
	{
		return new Entity<T1, T2, T3, T4, T5, T6, T7>(ent.Owner, ent.Comp1, ent.Comp2, ent.Comp3, default(T4), default(T5), default(T6), default(T7));
	}

	public static implicit operator Entity<T1, T2, T3, T4, T5?, T6?, T7?>(Entity<T1, T2, T3, T4> ent)
	{
		return new Entity<T1, T2, T3, T4, T5, T6, T7>(ent.Owner, ent.Comp1, ent.Comp2, ent.Comp3, ent.Comp4, default(T5), default(T6), default(T7));
	}

	public static implicit operator Entity<T1, T2, T3, T4, T5, T6?, T7?>(Entity<T1, T2, T3, T4, T5> ent)
	{
		return new Entity<T1, T2, T3, T4, T5, T6, T7>(ent.Owner, ent.Comp1, ent.Comp2, ent.Comp3, ent.Comp4, ent.Comp5, default(T6), default(T7));
	}

	public static implicit operator Entity<T1, T2, T3, T4, T5, T6, T7?>(Entity<T1, T2, T3, T4, T5, T6> ent)
	{
		return new Entity<T1, T2, T3, T4, T5, T6, T7>(ent.Owner, ent.Comp1, ent.Comp2, ent.Comp3, ent.Comp4, ent.Comp5, ent.Comp6, default(T7));
	}
	...
	public readonly Entity<T1?, T2?, T3?, T4?, T5?, T6?, T7?> AsNullable()
	{
		return new Entity<T1, T2, T3, T4, T5, T6, T7>(Owner, Comp1, Comp2, Comp3, Comp4, Comp5, Comp6, Comp7);
	}
...
[NotYamlSerializable]
public record struct Entity<T1, T2, T3, T4, T5, T6, T7, T8> : IFluentEntityUid, IAsType<EntityUid> where T1 : IComponent? where T2 : IComponent? where T3 : IComponent? where T4 : IComponent? where T5 : IComponent? where T6 : IComponent? where T7 : IComponent? where T8 : IComponent?
{
	readonly EntityUid IFluentEntityUid.FluentOwner => Owner;
	...
	{
		return new Entity<T1, T2, T3, T4, T5, T6, T7, T8>(tuple.Owner, tuple.Comp1, tuple.Comp2, tuple.Comp3, tuple.Comp4, tuple.Comp5, tuple.Comp6, tuple.Rest.Item1, tuple.Rest.Item2);
	}
	...
	{
		return new Entity<T1, T2, T3, T4, T5, T6, T7, T8>(tuple.Owner, tuple.Comp1, tuple.Comp2, tuple.Comp3, tuple.Comp4, tuple.Comp5, tuple.Comp6, tuple.Rest.Item1, default(T8));
	}
	...
	{
		return new Entity<T1, T2, T3, T4, T5, T6, T7, T8>(Owner, Comp1, Comp2, Comp3, Comp4, Comp5, Comp6, Comp7, Comp8);
	}
