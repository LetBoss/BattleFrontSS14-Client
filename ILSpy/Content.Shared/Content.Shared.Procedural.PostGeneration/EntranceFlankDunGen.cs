...
public sealed class EntranceFlankDunGen : IDunGenLayer, ISerializationGenerated<IDunGenLayer>, ISerializationGenerated, ISerializationGenerated<EntranceFlankDunGen>
{
	...
	public void InternalCopy(ref EntranceFlankDunGen target, ISerializationManager serialization, SerializationHookContext hookCtx, ISerializationContext? context = null)
	{
		...
		if (!serialization.TryCustomCopy<EntranceFlankDunGen>(this, ref target, hookCtx, false, context))
		{
	...
	[Obsolete("Use ISerializationManager.CopyTo instead")]
	public void Copy(ref EntranceFlankDunGen target, ISerializationManager serialization, SerializationHookContext hookCtx, ISerializationContext? context = null)
	{
	...
	{
		EntranceFlankDunGen cast = (EntranceFlankDunGen)target;
	...
	{
		EntranceFlankDunGen def = (EntranceFlankDunGen)target;
	...
	public EntranceFlankDunGen Instantiate()
	{
		return new EntranceFlankDunGen();
	}
