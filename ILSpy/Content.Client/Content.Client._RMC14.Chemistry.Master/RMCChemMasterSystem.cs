...
public sealed class RMCChemMasterSystem : SharedRMCChemMasterSystem
{
	...
	{
		base.Initialize();
		((EntitySystem)this).SubscribeLocalEvent<RMCChemMasterComponent, AfterAutoHandleStateEvent>((EntityEventRefHandler<RMCChemMasterComponent, AfterAutoHandleStateEvent>)OnState, (Type[])null, (Type[])null);
	}
	...
	protected override void RefreshUIs(Entity<RMCChemMasterComponent> ent)
	{
		...
		_rmcUI.RefreshUIs<RMCChemMasterBui>(Entity<UserInterfaceComponent>.op_Implicit(ent.Owner));
	}
}
