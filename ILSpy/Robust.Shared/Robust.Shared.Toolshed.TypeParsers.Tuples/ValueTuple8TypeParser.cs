...
public sealed class ValueTuple8TypeParser<T1, T2, T3, T4, T5, T6, T7, T8> : BaseTupleTypeParser<ValueTuple<T1, T2, T3, T4, T5, T6, T7, T8>> where T8 : unmanaged
{
	public override IEnumerable<Type> Fields => new Type[8]
	{
		typeof(T1),
		typeof(T2),
		typeof(T3),
